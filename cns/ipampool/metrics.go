...
var (
	ipamAllocatedIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_pod_allocated_ips"},
		},
	...
	ipamAvailableIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_available_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamBatchSize = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_batch_size"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamCurrentAvailableIPcount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_current_available_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamExpectedAvailableIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_expect_available_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamMaxIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_max_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamPendingProgramIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_pending_programming_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamPendingReleaseIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_pending_release_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamRequestedIPConfigCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_requested_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
	ipamTotalIPCount = prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			ConstLabels: prometheus.Labels{"customer_metric": "cx_ipam_total_ips"},
		},
		[]string{subnetLabel, subnetCIDRLabel, podnetARMIDLabel},
	)
)
