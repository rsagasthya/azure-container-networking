...
import (
	...
	"github.com/Azure/azure-container-networking/crd/clustersubnetstate/api/v1alpha"
...
// Scheme is a runtime scheme containing the client-go scheme and the ClusterSubnetState scheme.
...
func (c *Client) Get(ctx context.Context, key types.NamespacedName) (*v1alpha.ClusterSubnetState, error) {
	clusterSubnetState := &v1alpha.ClusterSubnetState{}
	err := c.nnccli.Get(ctx, key, clusterSubnetState)
	return clusterSubnetState, errors.Wrapf(err, "failed to get nnc %v", key)
}
...
func (c *Client) Install(ctx context.Context) (*v1.CustomResourceDefinition, error) {
	nnc, err := GetClusterSubnetStates()
	if err != nil {
...
// PatchSpec performs a server-side patch of the passed ClusterSubnetStateSpec to the ClusterSubnetState specified by the NamespacedName.
func (c *Client) PatchSpec(ctx context.Context, key types.NamespacedName, spec *v1alpha.ClusterSubnetStateSpec, fieldManager string) (*v1alpha.ClusterSubnetState, error) {
...
// UpdateSpec does a fetch, deepcopy, and update of the ClusterSubnetState with the passed spec.
// Deprecated: UpdateSpec is deprecated and usage should migrate to PatchSpec.
func (c *Client) UpdateSpec(ctx context.Context, key types.NamespacedName, spec *v1alpha.ClusterSubnetStateSpec) (*v1alpha.ClusterSubnetState, error) {
...
// SetOwnerRef sets the owner of the ClusterSubnetState to the given object, using HTTP Patch
func (c *Client) SetOwnerRef(ctx context.Context, key types.NamespacedName, owner metav1.Object, fieldManager string) (*v1alpha.ClusterSubnetState, error) {
	obj := genPatchSkel(key)
...
func genPatchSkel(key types.NamespacedName) *v1alpha.ClusterSubnetState {
